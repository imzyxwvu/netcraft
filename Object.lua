...
local function method_lookup_on(self, key)
	...
	while the_class do
		if the_class.__methods[key] then
			return the_class.__methods[key]
		else
...
function Class_MT:__index(key)
	return Class[key] or self.__methods[key]
end

function Class_MT:__newindex(key, value)
	if value == nil then
		self.__methods[key] = nil
	else
...
function Class:extend() 
	return classify{ __parent = self, __methods = {} }
end
...
local Object = classify{ __methods = {} }
